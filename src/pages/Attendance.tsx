    ...
    return (
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8 pb-10">
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    { icon: Users, label: t.attendancePage.totalStudents, value: String(attendanceRows.length), gradient: '', shadow: '' },
                    { icon: CheckCircle2, label: t.attendancePage.present, value: String(presentCount), gradient: '', shadow: '' },
                    { icon: Clock, label: t.attendancePage.late, value: String(lateCount), gradient: '', shadow: '' },
                    { icon: XCircle, label: t.attendancePage.absent, value: String(absentCount), gradient: '', shadow: '' },
                ].map((stat, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                {/* Settings Panel */}
                <motion.div variants={itemVariants} className="lg:col-span-1 bg-white dark:bg-[#0c1222] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-6 shadow-sm h-fit">
                ...
                <motion.div variants={itemVariants} className="lg:col-span-3 bg-white dark:bg-[#0c1222] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="flex justify-between items-center mt-6 pt-4 border-t border-slate-100 dark:border-slate-700">
                        ...
                        <Button className="rounded-xl bg-emerald-600 hover:bg-emerald-700 shadow-sm">
